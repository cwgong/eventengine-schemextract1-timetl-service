...
def post_test():
    ...
    url_obj = 'http://10.0.0.157:9983/schemaExtract' #服务器目标地址，无需做改变
    # url_obj = 'http://htmltopdf-shuffle-service:31001/datetime'
    doc = {'id': '121313123123',
           'title': "光弘科技独立董事梁烽先生逝世",
           'url': "www.baidu.com",
           'dataSource': "",
           'publishAt':1571919900476,
    ...
    results = requests_post(url_obj, list_of_doc)
    print(results)
